...
__host__ __device__ glm::vec3 getRandomDirectionInSphere(float xi1, float xi2) {
  //TODO:: find out the parameter xi1 xi2 mean and what this function really do.
	thrust::default_random_engine rng(hash(2));
    ...
    return dire;//stay in this form for now, don't know the meaning
}
